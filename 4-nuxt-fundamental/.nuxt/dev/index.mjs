globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, getQuery as getQuery$1, createError } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_GZEGKt = () => Promise.resolve().then(function () { return helloWorld_get$1; });
const _lazy_CqY2Px = () => Promise.resolve().then(function () { return helloWorld_post$1; });
const _lazy_JPFEK3 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/helloWorld', handler: _lazy_GZEGKt, lazy: true, middleware: false, method: "get" },
  { route: '/api/helloWorld', handler: _lazy_CqY2Px, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_JPFEK3, lazy: true, middleware: false, method: undefined },
  { route: '/swr', handler: _lazy_JPFEK3, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_JPFEK3, lazy: true, middleware: false, method: undefined }
];
...
const helloWorld_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: helloWorld_get
});
...
const helloWorld_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: helloWorld_post
});
...
const getClientManifest = () => import('/Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/rojsiroj/Projects/VueSchool/4-nuxt-fundamental/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
